...
give @s bow[enchantments={flame:1, punch:2, infinity:1}]
give @s spectral_arrow 1
give @s potion[potion_contents={potion:fire_resistance}]
give @s splash_potion[potion_contents={potion:weakness}]
